# -*- coding: utf-8 -*-
"""
Created on Sun May 17 13:08:03 2020
...
tempToDensity = {-25 : 1.4224, -20 : 1.3943, -15 : 1.3673, -10 : 1.3413, -5 : 1.3163, 0 : 1.2922, 5 : 1.2690, 10 : 1.2466, 15 : 1.2250, 20 : 1.2041, 25 : 1.1839, 30 : 1.1644, 35 : 1.1455}
...
r       = 0.0325               # Radius of projectile (m)
m       = 0.105                # Mass of projectile (kg)
temp = 15                      #Temperature of air (centigrade)
rho_air = tempToDensity[temp]   # Air density (kg/m^3)
...
print('Temperature of air (centigrade)          : {:.3f}'.format(temp))
...
x_0 = 0.0
u_0 = V_0 * cos(psi)    #dikey hız vektörü
y_0 = 10.0
v_0 = V_0 * sin(psi)    #yatay hız vektörü
